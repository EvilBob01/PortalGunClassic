...
public class EventHandlerCommon
{
    ...
    public static void onRegisterPayloads(RegisterPayloadHandlersEvent event)
    {
        ...
        registrar.playToServer(PacketSwapType.TYPE,        PacketSwapType.STREAM_CODEC,        PacketSwapType::handle);
    ...
    public static void onBuildCreativeTab(BuildCreativeModeTabContentsEvent event)
    {
        ...
        {
            event.accept(ModRegistries.ITEM_PORTAL_GUN_BLUE);
            event.accept(ModRegistries.ITEM_PORTAL_GUN_ORANGE);
        }
